...
#[bench]
fn bench_rate_4_80_bits(b: &mut test::Bencher) {
    let rate = 4u32;
    let capacity = 1u32;
    let num_full = 8u32;
    let num_partial = 35u32;
    let security_level = 80u32;
    let params = Bn256PoseidonParams::new_for_params::<BlakeHasher>(capacity, rate, num_partial, num_full, security_level);
    let rng = &mut thread_rng();
    let input = (0..rate).map(|_| Fr::rand(rng)).collect::<Vec<_>>();
...
#[bench]
fn bench_rate_4_128_bits(b: &mut test::Bencher) {
    let rate = 4u32;
    let capacity = 1u32;
    let num_full = 8u32;
    let num_partial = 60u32;
    let security_level = 80u32;
    let params = Bn256PoseidonParams::new_for_params::<BlakeHasher>(capacity, rate, num_partial, num_full, security_level);
    let rng = &mut thread_rng();
    let input = (0..rate).map(|_| Fr::rand(rng)).collect::<Vec<_>>();
...
#[bench]
fn bench_rate_8_128_bits(b: &mut test::Bencher) {
    let rate = 8u32;
    let capacity = 1u32;
    let num_full = 8u32;
    let num_partial = 63u32;
    let security_level = 80u32;
    let params = Bn256PoseidonParams::new_for_params::<BlakeHasher>(capacity, rate, num_partial, num_full, security_level);
    let rng = &mut thread_rng();
    let input = (0..rate).map(|_| Fr::rand(rng)).collect::<Vec<_>>();
...
#[bench]
fn bench_rate_4_256_bits(b: &mut test::Bencher) {
    let rate = 4u32;
    let capacity = 2u32;
    let num_full = 8u32;
    let num_partial = 120u32;
    let security_level = 256u32;
    let params = Bn256PoseidonParams::new_for_params::<BlakeHasher>(capacity, rate, num_partial, num_full, security_level);
    let rng = &mut thread_rng();
    let input = (0..rate).map(|_| Fr::rand(rng)).collect::<Vec<_>>();
...
#[bench]
fn bench_rate_8_256_bits(b: &mut test::Bencher) {
    let rate = 8u32;
    let capacity = 2u32;
    let num_full = 8u32;
    let num_partial = 120u32;
